...
@Data
@AllArgsConstructor
@Schema(description = "Data Transfer Object representing a completed job's information, including vehicle, order, customer, and job completion details")
public class DoneJobTableInfoDto {
